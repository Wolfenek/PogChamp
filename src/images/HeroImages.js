...
const HeroImages = [
  ...
  { id: "bastion", src: `${Bastion}`, altTag: "bastion overwatch" },
  { id: "brigitte", src: `${Brigitte}`, altTag: "brigitte overwatch" },
  { id: "dva", src: `${DVa}`, altTag: "d.va overwatch" },
  { id: "doomfist", src: `${Doomfist}`, altTag: "doomfist overwatch" },
  { id: "genji", src: `${Genji}`, altTag: "genji genji" },
  { id: "hanzo", src: `${Hanzo}`, altTag: "hanzo overwatch" },
  { id: "junkrat", src: `${Junkrat}`, altTag: "junkrat overwatch" },
  { id: "lucio", src: `${Lucio}`, altTag: "lucio overwatch" },
  { id: "mccree", src: `${McCree}`, altTag: "mccree overwatch" },
  { id: "mei", src: `${Mei}`, altTag: "mei overwatch" },
  { id: "mercy", src: `${Mercy}`, altTag: "mercy overwatch" },
  { id: "moira", src: `${Moira}`, altTag: "moira overwatch" },
  { id: "orisa", src: `${Orisa}`, altTag: "orisa overwatch" },
  { id: "pharah", src: `${Pharah}`, altTag: "pharah overwatch" },
  { id: "reaper", src: `${Reaper}`, altTag: "reaper overwatch" },
  { id: "reinhardt", src: `${Reinhardt}`, altTag: "reinhardt overwatch" },
  { id: "roadhog", src: `${Roadhog}`, altTag: "roadhog overwatch" },
  { id: "soldier", src: `${Soldier}`, altTag: "soldier 76 overwatch" },
  { id: "sombra", src: `${Sombra}`, altTag: "sombra overwatch" },
  { id: "symmetra", src: `${Symmetra}`, altTag: "symmetra overwatch" },
  { id: "torbjörn", src: `${Torbjörn}`, altTag: "torbjörn overwatch" },
